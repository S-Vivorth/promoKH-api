...
import com.kit.promokhapi.dto.LoginDTO;
import com.kit.promokhapi.dto.ResponseDTO;
import com.kit.promokhapi.dto.SignupDTO;
import com.kit.promokhapi.dto.TokenDTO;
...
public class AuthController {
    ...
    public ResponseEntity<?> login(@Valid @RequestBody LoginDTO dto) {
        ...
        TokenDTO tokenDTO = new TokenDTO(user.getId(), accessToken, refreshTokenString);
    ...
    public ResponseEntity<?> refreshToken(@RequestBody TokenDTO dto) {
        ...
        if (jwtHelper.validateRefreshToken(refreshTokenString)
            ...
            TokenDTO tokenDTO = new TokenDTO(user.getId(), accessToken, newRefreshTokenString);
